...
const PostUpdate = () => {
    ...
    return (
        <div className="sample-post-update">
            <div className="post-update-photo"><img src="https://images.squarespace-cdn.com/content/v1/5e6ece70bd2f8a6de8472818/714f685e-d0ba-40f9-8bb2-38722c1fd29c/Tiny+Avatar.png?format=1000w"></img></div>
            <div>
